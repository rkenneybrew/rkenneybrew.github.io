...
<head>
    <title>Code coverage report for apis/options-wrapper.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">apis</a> options-wrapper.ts</h1>
        <div class='clearfix'>
...
export class OptionsWrapperWithGetter&lt;T&gt; extends OptionsWrapper&lt;T&gt; {
   ...
   */
<span class="fstat-no" title="function not covered" >  get o</span>ptions(): T {
...
&nbsp;
   ...
   * @memberof OptionsWrapperWithSetter
   */
<span class="fstat-no" title="function not covered" >  set o</span>ptions(value: T) {
<span class="cstat-no" title="statement not covered" >    this._options = value;</span>
  }
}
&nbsp;</pre></td></tr></table></pre>
