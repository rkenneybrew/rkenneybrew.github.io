...
<head>
    <title>Code coverage report for apis/shared/environment.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">apis/shared</a> environment.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  for (const key of keys) {
    Object.defineProperty(environment, key, {
      get: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >getOwnProperty(baseEnvironment, key)</span>
    });
  }
&nbsp;
  return environment;
