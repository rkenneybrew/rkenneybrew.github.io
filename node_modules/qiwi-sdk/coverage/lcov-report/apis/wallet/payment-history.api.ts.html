...
<head>
    <title>Code coverage report for apis/wallet/payment-history.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">apis/wallet</a> payment-history.api.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { formatQuerystring } from "../shared";
...
export class WalletPaymentHistoryApi extends WalletApi {
   ...
   */
<span class="fstat-no" title="function not covered" >  async </span>getHistory(
    parameters: GetPaymentHistoryParameters
  ): Promise&lt;GetTransactionsHistoryResponse&gt; {
<span class="cstat-no" title="statement not covered" >    return await this.http.get(</span>
   ...
   * @memberof WalletPaymentHistoryApi
   */
<span class="fstat-no" title="function not covered" >  async </span>getTotal(
...
<span class="cstat-no" title="statement not covered" >    return await this.http.get(</span>
   ...
   * @memberof WalletPaymentHistoryApi
   */
<span class="fstat-no" title="function not covered" >  async </span>getTransaction(
...
&nbsp;
   ...
   * @memberof WalletPaymentHistoryApi
   */
<span class="fstat-no" title="function not covered" >  async </span>getTransactionCheque(
    transactionId: StringOrNumber,
    type: TransactionTypeAny,
    format: ChequeFormat = <span class="branch-0 cbranch-no" title="branch not covered" >ChequeFormat.JPEG</span>
  ): Promise&lt;Buffer&gt; {
<span class="cstat-no" title="statement not covered" >    return await this.http.request({</span>
      ...
      method: "GET",
      parseResponse: <span class="fstat-no" title="function not covered" >(b</span>ody) =&gt; <span class="cstat-no" title="statement not covered" >body</span>
    });
  }
&nbsp;
  /**
