...
<head>
    <title>Code coverage report for apis/wallet/limits.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">apis/wallet</a> limits.api.ts</h1>
        <div class='clearfix'>
...
export class WalletLimitsApi extends WalletApi {
   ...
   */
<span class="fstat-no" title="function not covered" >  async </span>get&lt;Limits extends LimitTypeAny[] = LimitTypeAny[]&gt;(
    limits: Limits
