...
<head>
    <title>Code coverage report for apis/wallet/funding-sources.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">apis/wallet</a> funding-sources.api.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { WalletApi } from "./api";
...
export class WalletFundingSourcesApi extends WalletApi {
   ...
   */
<span class="fstat-no" title="function not covered" >  async </span>getAccounts(): Promise&lt;GetAccountsResponse["accounts"]&gt; {
    const { accounts } = <span class="cstat-no" title="statement not covered" >await this.http.get(</span>
      `funding-sources/v2/persons/${this.walletId}/accounts`
    );
&nbsp;
<span class="cstat-no" title="statement not covered" >    return accounts;</span>
  }
&nbsp;
  /**
   * ## Создание баланса
...
&nbsp;
   ...
   * @memberof WalletFundingSourcesApi
   */
<span class="fstat-no" title="function not covered" >  async </span>getAccountOffers(): Promise&lt;GetAccountOffersResponse&gt; {
