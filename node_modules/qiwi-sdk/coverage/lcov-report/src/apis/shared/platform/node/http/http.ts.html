...
<head>
    <title>Code coverage report for src/apis/shared/platform/node/http/http.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">src/apis/shared/platform/node/http</a> http.ts</h1>
        <div class='clearfix'>
...
<a name='L128'></a><a href='#L128'>128</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { OptionsWrapperWithSetter } from "@apis/options-wrapper";
  ...
  protected _mapResponse(
    ...
    const data =
      ...
      axiosResponse.data instanceof Uint8Array
        ...
        : <span class="branch-1 cbranch-no" title="branch not covered" >new Uint8Array();</span>
&nbsp;
    let body: any;
&nbsp;
    try {
