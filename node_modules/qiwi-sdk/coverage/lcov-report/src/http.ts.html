...
<head>
    <title>Code coverage report for src/http.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> http.ts</h1>
        <div class='clearfix'>
...
<a name='L283'></a><a href='#L283'>283</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
&nbsp;
    const okStatusCodes = new Set(
      request.okStatusCodes ? collect(request.okStatusCodes) : <span class="branch-1 cbranch-no" title="branch not covered" >[]</span>
    );
&nbsp;
    const validateStatus = (status: number) =&gt;
      okStatusCodes.size === 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >true </span>: okStatusCodes.has(status);
&nbsp;
    try {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!(error instanceof HttpError)) <span class="cstat-no" title="statement not covered" >throw error;</span>
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof request.mapHttpErrors !== "function") <span class="cstat-no" title="statement not covered" >throw error;</span>
&nbsp;
...
&nbsp;
   ...
   * @memberof SimpleJsonHttp
   */
<span class="fstat-no" title="function not covered" >  async </span>patch&lt;T&gt;(url: string, data?: any): Promise&lt;T&gt; {
...
&nbsp;
   ...
   * @memberof SimpleJsonHttp
   */
<span class="fstat-no" title="function not covered" >  async </span>delete&lt;T&gt;(url: string, data?: any): Promise&lt;T&gt; {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue May 03 2022 03:29:34 GMT+0300 (Москва, стандартное время)
            </div>
