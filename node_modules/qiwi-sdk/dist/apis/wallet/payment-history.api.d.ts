...
import { GetPaymentHistoryParameters as GetPaymentHistoryParameters, GetTransactionsHistoryResponse, GetPaymentHistoryTotalParameters as GetPaymentHistoryTotalParameters, GetPaymentHistoryTotalResponse, Transaction, StringOrNumber, ChequeFormat, TransactionTypeAny } from "./wallet.types";
/**
 * # История платежей
...
export declare class WalletPaymentHistoryApi extends WalletApi {
     ...
     * @memberof WalletPaymentHistoryApi
     */
    getTransactionCheque(transactionId: StringOrNumber, type: TransactionTypeAny, format?: ChequeFormat): Promise<Uint8Array>;
    /**
     * ### Отправка квитанции
     *
