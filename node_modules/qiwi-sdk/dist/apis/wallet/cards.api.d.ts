...
import type { CardResponse, StringOrNumber, CardUnblockResponse, CardRequisitesResponse, CardRenameResponse } from "./wallet.types";
/**
 * # API QIWI Мастер
...
export declare class WalletCardsApi extends WalletApi {
     ...
     */
    get({ onlyQiwiMaster }?: {
        onlyQiwiMaster?: boolean | undefined;
