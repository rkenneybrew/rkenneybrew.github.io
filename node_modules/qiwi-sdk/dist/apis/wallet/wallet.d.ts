...
export declare class Wallet extends ApiClass<WalletApiOptions> {
    ...
    static readonly IdentificationLevel: typeof PersonIdentificationLevel;
    static readonly ReceiptFormat: typeof ChequeFormat;
    ...
    static readonly NicknameApi: typeof WalletNicknameApi;
    static readonly OauthApi: typeof WalletOauthApi;
    /**
     *
     *
     * @static
