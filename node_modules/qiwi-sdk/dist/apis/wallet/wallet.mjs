...
import { WalletNicknameApi } from "./nickname.api.mjs";
import { WalletOauthApi } from "./oauth.api.mjs";
/**
 * # API Кошелька
...
Wallet.IdentificationLevel = PersonIdentificationLevel;
Wallet.ReceiptFormat = ChequeFormat;
...
Wallet.NicknameApi = WalletNicknameApi;
Wallet.OauthApi = WalletOauthApi;
/**
 *
 *
 * @static
