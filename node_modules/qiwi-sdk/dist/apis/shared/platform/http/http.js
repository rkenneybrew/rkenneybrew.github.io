...
const optionsWrapper = require("../../../options-wrapper.js"),
  ...
  http_types = require("../../http.types.js"),
 ...
 */
class AxiosHttpClient extends optionsWrapper.OptionsWrapperWithSetter {
  constructor() {
    super(...arguments);
    /**
     *
    ...
    try {
      const axiosResponse = await this._axios
        .request({
          ...
          data: request.body
            ? ((_a = request.stringifyBody) !== null && _a !== void 0 ? _a : pass._)(
                request.body
              )
            : undefined,
          validateStatus
        ...
        .catch((error) => {
          if (axios.isAxiosError(error) && error.response) {
            throw new http_types.HttpError(
              error.message,
      ...
      if (
        ...
        error instanceof http_types.HttpError
      ) {
  ...
  _mapResponse(axiosResponse, request) {
    ...
    let body;
    try {
      body = ((_a = request.parseResponse) !== null && _a !== void 0 ? _a : pass._)(
        data
      );
    } catch (_b) {
      body = data;
