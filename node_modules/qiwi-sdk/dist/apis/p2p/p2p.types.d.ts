...
export type BillFormParameters = PayUrlPatchParameters & BillCustomFieldsExtension & {
    /** Уникальный идентификатор выставляемого счета в вашей системе */
    billId?: string;
    /**
...
export type BillCreateParameters = BillCreationRequest & PayUrlPatchParameters & {
    billId?: string;
};
