...
import type { BillCreateParameters, BillFormParameters as BillFormParameters, BillRefundStatusData, BillStatusBody, BillStatusData, BillStatusNotificationBody, PayUrlPatchParameters, RefundCreationRequest } from "./p2p.types";
/**
 * # P2P-счета
...
export declare class P2pBillsApi extends P2pApi {
     ...
     * @memberof P2pBillsApi
     */
    checkNotificationSignature(signature: string, body: BillStatusNotificationBody | BillStatusBody, merchantSecret?: string): boolean;
    /**
