...
d){for(var c=0,b=a.length;c<b;c++)d(a[c],c,a)};a.map=b.map?function(a,d){return a.map(d)}:function(a,d){var c=[];e(a,function(a,b,f){c.push(d(a,b,f))});return c};a.filter=b.filter?function(a,c){return a.filter(c)}:function(a,c){var b=[];e(a,function(a,j,f){c(a,j,f)&&b.push(a)});return b};a.unique=function(a){var c=[],b={};e(a,function(a){b[a]=1});if(Object.keys)c=Object.keys(b);else for(var i in b)b.hasOwnProperty(i)&&c.push(i);return c};a.now=Date.now||function(){return(new Date).getTime()}})(seajs._util);
...
var d=c;a.forEach(b,function(a){a&&1<a.length&&(d=d.replace(a[0],a[1]))});m[d]=c;return d};a.unParseMap=function(a){return m[a]||a};a.id2Uri=function(a,c){var a=i(a),c=c||n,b;j(a)?b=a:0===a.indexOf("./")||0===a.indexOf("../")?(a=a.replace(/^\.\//,""),b=k(c)+a):b="/"===a.charAt(0)&&"/"!==a.charAt(1)?c.replace(/^(\w+:\/\/[^\/]*)\/?.*$/,"$1")+a:g.base+"/"+a;return h(b)};a.isAbsolute=j;a.isTopLevel=f;a.pageUrl=n})(seajs._util,seajs._data,seajs._fn,this);
...
(g=a.unParseMap(a.getScriptAbsoluteSrc(h))),g||a.log("Failed to derive URL from interactive script for:",d.toString()));h=new b.Module(e,k,d);g?(a.memoize(g,h),c.packageMods.push(h)):c.anonymousMod=h}})(seajs._util,seajs._data,seajs._fn);
...
b))return!0;return!1}var l=c.memoizedMods,t=c.config,q=b.Require.prototype,o=0,u=[],s={},r={},v={},p={};a.memoize=i;b.preload=e;b.load=k})(seajs._util,seajs._data,seajs._fn);
(function(a,c,b,e){function k(a,b){a&&a!==b&&c.error("Alias is conflicted:",b)}var d=b.config,h="seajs-ts="+c.now(),b=document.getElementById("seajsnode");b||(b=document.getElementsByTagName("script"),b=b[b.length-1]);var i=c.getScriptAbsoluteSrc(b)||c.pageUrl,i=c.dirname(i);c.loaderDir=i;var j=i.match(/^(.+\/)seajs\/[\d\.]+\/$/);j&&(i=j[1]);d.base=i;if(b=b.getAttribute("data-main"))c.isTopLevel(b)&&(b="./"+b),d.main=b;d.timeout=2E4;e.config=function(b){for(var g in b){var i=d[g],j=b[g];if(i&&"alias"===
g)for(var l in j)j.hasOwnProperty(l)&&(k(i[l],j[l]),i[l]=j[l]);else i&&("map"===g||"preload"===g)?(c.isArray(j)||(j=[j]),c.forEach(j,function(a){a&&i.push(a)})):d[g]=j}if((b=d.base)&&!c.isAbsolute(b))d.base=c.id2Uri("./"+b+"#");2===d.debug&&(d.debug=1,e.config({map:[[/.*/,function(a){-1===a.indexOf("seajs-ts=")&&(a+=(-1===a.indexOf("?")?"?":"&")+h);return a}]]}));d.debug&&(a.debug=d.debug);return this}})(seajs,seajs._util,seajs._data,seajs._fn);
(function(a,c,b,e){var a=a.config,k={},d=c.loaderDir;c.forEach("base,map,text,json,coffee,less".split(","),function(a){a="plugin-"+a;k[a]=d+a});b.config({alias:k});if(~e.location.search.indexOf("seajs-debug")||~document.cookie.indexOf("seajs=1"))b.config({debug:2}),a.preload.push("plugin-map")})(seajs._data,seajs._util,seajs._fn,this);
(function(a,c,b){b.use=function(a,c){b.preload(function(){b.load(a,c)})};(c=c.config.main)&&b.use([c]);(function(c){if(c){for(var k={"0":"config",1:"use",2:"define"},d=0;d<c.length;d+=2)b[k[c[d]]].apply(a,c[d+1]);delete a._seajs}})((a._seajs||0).args)})(seajs,seajs._data,seajs._fn);
(function(a,c,b,e){if(a._seajs)e.seajs=a._seajs;else{a.config=b.config;a.use=b.use;var k=e.define;e.define=b.define;a.noConflict=function(c){e.seajs=a._seajs;c&&(e.define=k,a.define=b.define);return a};a.pluginSDK={util:a._util,data:a._data};if(c=c.config.debug)a.debug=!!c;delete a._util;delete a._data;delete a._fn;delete a._seajs}})(seajs,seajs._data,seajs._fn,this);
