...
let detectLoaderChanges = async ctx => {
  ...
  let entries = Object.entries(metafile.outputs).map(([hashjs, {
    entryPoint
  }]) => {
    var _entryPoint$replace;
    let file = entryPoint === null || entryPoint === void 0 ? void 0 : (_entryPoint$replace = entryPoint.replace(/^hmr-loader:/, "")) === null || _entryPoint$replace === void 0 ? void 0 : _entryPoint$replace.replace(/\?loader$/, "");
